...
function Faq() {
  return (
    <section className="faq">
      <div className="faqs">
      <div className="text-wrapper-15">Frequently Asked Questions</div>
    <div className="text">
...
<br></br>
Answer: Yes, we provide online ordering and tracking for print projects. Our user-friendly platform allows clients to place orders, monitor progress, and receive updates conveniently.</div>
